...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#f3f5f9] text-[#1F2937] py-8 mt-0">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
          ...
          <div className="flex space-x-6 justify-center sm:justify-start">
            <a
              ...
              aria-label="GitHub"
              className="text-[#1F2937] hover:text-purple-600 hover:-translate-y-1 hover:scale-110 transform transition duration-300"
            >
              <FaGithub size={24} />
            </a>
        ...
        <div className="border-t border-[#9da5b1] pt-6 text-center">
          <p className="text-[#1F2937] text-sm">
            &copy; {currentYear} Arunvasam. Let's build something great
            together!
          </p>
        </div>
      </div>
